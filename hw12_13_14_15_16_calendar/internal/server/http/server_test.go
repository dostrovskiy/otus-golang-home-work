...
func TestServer(t *testing.T) {
	...
	t.Run("basic crud", func(t *testing.T) {
		...
		require.True(t, event.Start.Round(0).Equal(getEvent.Start.Round(0)),
			"expected %v, got %v", event.Start.Round(0), getEvent.Start.Round(0))
		...
		require.True(t, newEvent.Start.Round(0).Equal(updEvent.Start.Round(0)),
			"expected %v, got %v", newEvent.Start.Round(0), updEvent.Start.Round(0))
